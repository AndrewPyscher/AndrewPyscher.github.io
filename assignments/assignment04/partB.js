...
let person = {
  ...
  lastName: "Doe",
  age: 45,
  streetAddress: "255 CSS Lane",
  city: "Bay City",
  state: "MI",
  zipCode: "48706",
  fullName: function() {return this.firstName  + " " + person.lastName},

  fullAddress: function( ){return "Age " + this.age + ", " + this.streetAddress + ", " + this.city + ", "+ this.state + ", " +  this.zipCode}
}
...
// 8. create "totals" row and column in a tablet


let div3b = document.getElementById("3B");
myTable = document.getElementsByTagName("table")[2];
myClone = myTable.cloneNode(true);
div3b.appendChild(myClone);

let column1Totals = 0;

appendTableRow3(myClone, "Totals:", columnTotal(myClone.children[0].children[1].children[1].innerHTML, myClone.children[0].children[2].children[1].innerHTML, myClone.children[0].children[3].children[1].innerHTML),
columnTotal(myClone.children[0].children[1].children[2].innerHTML, myClone.children[0].children[2].children[2].innerHTML, myClone.children[0].children[3].children[2].innerHTML));



let multiply1 = multiply(myClone.children[0].children[1].children[1].innerHTML, myClone.children[0].children[1].children[2].innerHTML);
let multiply2 = multiply(myClone.children[0].children[2].children[1].innerHTML, myClone.children[0].children[2].children[2].innerHTML);
let multiply3 = multiply(myClone.children[0].children[3].children[1].innerHTML, myClone.children[0].children[3].children[2].innerHTML);
let multiply4 = multiply(myClone.children[0].children[4].children[1].innerHTML, myClone.children[0].children[4].children[2].innerHTML);
...
function columnTotal(row1, row2, row3){
  let total = parseFloat(row1) + parseFloat(row2) + parseFloat(row3);
  return total;
}
...
// code below is from: https://www.guru99.com/practical-code-examples-using-javascript.html 
    ...
    function validate() {
        ...
        for (i in inputs) {
            ...
            let div = divs[i];
            if (inputs[i] == ""){}
                // this line of code below isnt needed
                // document.getElementById(div).innerHTML = errMessage;
            else if (i == 2) {
              //checks to see if the input is a proper email by seeing if there is at least 2 characters after the "." and and @ sign
                ...
                // checks if the first password matches the second
                if (second != first)
